...
*/
function annona_dropdown_posts(){

	class Annona_Dropdown_Posts_Control extends WP_Customize_Control{
		...
		public function render_content(){
			...
			<label>
				...
				<select <?php $this->link() ?>>
					<option value=""><?php esc_html_e( 'None (default)' , 'anona' ) ?></option>
...
add_action( 'customize_register', 'annona_dropdown_posts', 1, 0 );